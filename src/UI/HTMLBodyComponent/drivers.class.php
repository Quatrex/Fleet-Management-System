    ...
    public function create(): void{
        ...
        foreach ($this->drivers as $driver) {
            $driverCard = $this->compositeBuilder
                ...
                ->addElement('img', ['class' => "card-img-top rounded-circle user-image mt-2 empCardImg", 'src' => "../images/default-user-image.png", 'alt' => "Driver Image " . $driver->getField('firstName') . ' ' . $driver->getField('lastName'), 'style' => 'height: 15rem;'])
                ->composite()
