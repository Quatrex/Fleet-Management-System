...
class MainNavBar extends HTMLBodyComponent
{
    ...
    public function create():void
    {
        ...
        $this->bodyComponent =
            ...
            ->addElement('img', ['src' => $this->employee->getField('profilePicturePath') != null ? "../images/profilePictures/" . $this->employee->getField('profilePicturePath') : "../images/default-user-image.png", 'class' => "rounded-circle user-image mt-2 ProfilePicture UserProfilePicture", 'style' => "height:35px;"])
            ->get()
            ->composite()
            ...
            ->addElement('img', ['class' => 'ProfilePicture UserProfilePicture ig-fluid', 'src' => $this->employee->getField('profilePicturePath') != null ? "../images/profilePictures/" . $this->employee->getField('profilePicturePath') : "../images/default-user-image.png"])
            ->composite()
