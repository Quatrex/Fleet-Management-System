    ...
    public function employees(array $employees): HTMLBuilder
    {
        ...
        foreach ($employees as $employee) {
            $employeeCard = $this->compositeBuilder
                ...
                ->composite()
                ->createComposite('div', ['class' => 'card text-center', 'style' => 'width: 15rem;'])
                ->addElement('img', ['class' => "card-img-top rounded-circle user-image mt-2", 'src' => $employee->getField('profilePicturePath') != null ? "../images/userProfilePictures/" . $employee->getField('profilePicturePath') : "../images/default-user-image.png", 'alt' => "Driver Image"])
                ->composite()
                ->createComposite('div', ['class' => 'card-body'])
                ...
                ->composite()
                    ...
                    ->composite()
                        ...
                        ->composite()
                            ...
                            ->composite()
                                ->createComposite('button', ['type'=>"button", 'class'=>"btn btn btn-outline-dark searchTabButton", 'id'=> 'Desc_'.str_replace(' ','',lcfirst($header))])
                                ->composite()
                                ...
                                ->get()
                            ->composite()
                                ->createComposite('button', ['type'=>"button", 'class'=>"btn btn btn-outline-dark searchTabButton", 'id'=> 'Asc_'.str_replace(' ','',lcfirst($header))])
                                ->composite()
