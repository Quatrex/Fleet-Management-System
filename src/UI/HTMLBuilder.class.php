...
class HTMLBuilder
{
    ...
    public function createMainNavBar(Employee $employee, array $navList = []): HTMLBuilder
    {
        ...
        $mainNavBar =
            ...
            ->composite()
            ->createComposite('button', ['class' => "menu-toggle navbar-toggler", 'type' => "button", 'style'=>"margin-top: 17px;"])
            ...
            ->addElement('img', ['src' => $employee->getField('profilePicturePath') != null ? "../images/profilePictures/" . $employee->getField('profilePicturePath') : "../images/default-user-image.png", 'class' => "rounded-circle user-image mt-2 ProfilePicture UserProfilePicture", 'style' => "height:35px;"])
            ->get()
            ->composite()
            ...
            ->addElement('img', ['class' => 'ProfilePicture UserProfilePicture ig-fluid', 'src' => $employee->getField('profilePicturePath') != null ? "../images/profilePictures/" . $employee->getField('profilePicturePath') : "../images/default-user-image.png"])
            ->composite()
    ...
    private function getButtonForSecTab($navId)
    {
