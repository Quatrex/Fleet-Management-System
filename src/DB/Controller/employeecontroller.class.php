...
{
    public function saveRecord($empID, $firstName, $lastName, $position, $designation, $email, $password)
    {
        parent::saveRecord($empID, $firstName, $lastName, $position, $designation, $email, $password);
    }
