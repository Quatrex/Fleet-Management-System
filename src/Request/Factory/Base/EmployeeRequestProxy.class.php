...
abstract class EmployeeRequestProxy implements Request, JsonSerializable
{
    ...
    public function jsonSerialize()
    {
        return ['RequestId'=>$this->getField('requestID'),
                ...
                'RequesterName' =>($this->getField('requester'))->getField('firstName') . ' ' . ($this->getField('requester'))->getField('lastName'),
                'Designation' => ($this->getField('requester'))->getField('designation'),
